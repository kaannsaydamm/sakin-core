...
public class AgentCommandWorker : BackgroundService
{
    ...
    {
        _logger.LogInformation("Linux Agent Command Worker starting up for agent: {AgentId}", _agentOptions.AgentId);
        ...
        try
        {
            ...
            while (!stoppingToken.IsCancellationRequested)
            {
                ...
                {
                    _logger.LogInformation("Linux Agent Command Worker stopping...");
                    break;
                }
                catch (Exception ex)
                {
        ...
        {
            _logger.LogError(ex, "Linux Agent Command Worker failed to start");
            throw;
        }
        finally
        {
